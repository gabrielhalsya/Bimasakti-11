...
namespace LMM06500MODEL
{
    public class LMM06500Model : R_BusinessObjectServiceClientBase<LMM06500DTO>, ILMM06500
    {
        ...
        public async Task<List<LMM06500DTOInitial>> GetPropertyAsync()
        {
            ...
            List<LMM06500DTOInitial> loResult = new List<LMM06500DTOInitial>();

            try
            {
                R_HTTPClientWrapper.httpClientName = _HttpClientName;
                var loTempResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<LMM06500DTOInitial>(
        ...
        {
            var loEx = new R_Exception();
            List<LMM06500DTO> loResult = new List<LMM06500DTO>();
            ...
            try
            {
                ...
                R_HTTPClientWrapper.httpClientName = _HttpClientName;
                var loTempResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<LMM06500DTO>(
                    _RequestServiceEndPoint,
