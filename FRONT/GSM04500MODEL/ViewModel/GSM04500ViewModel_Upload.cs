...
namespace GSM04500Model.ViewModel
{
    public class GSM04500ViewModel_Upload : R_IProcessProgressStatus
    {
        ...
        public ObservableCollection<ExcelValidateDTO> JournalGroupValidateUploadError { get; set; } = new ObservableCollection<ExcelValidateDTO>();
        public bool _IsSuccess { get; set; }
        public bool VisibleColumn_LACCRUAL;
        //CONVERT DTO
        public async Task ConvertGrid(List<ExcelDTO> poEntity)
        {
            ...
            try
            {
                ...
                List<ExcelValidateDTO> Data = poEntity.Select((item, i)
                    => new ExcelValidateDTO
                    {
                        No = i + 1,
                ...
                JournalGroupValidateUploadError = new ObservableCollection<ExcelValidateDTO>(Data);
        ...
        public async Task SaveFileBulk()
        {
            ...
            List<ExcelValidateDTO> ListFromExcel;
            ...
            try
            {
                ...
                await loCls.R_BatchProcess<List<ExcelValidateDTO>>(loBatchPar, 10);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task ServiceGetError(string pcKeyGuid)
        {
            ...
            try
            {
                ...
                if (loResultData.Any(y => y.SeqNo > 0))
                {
                    ...
                    List<ExcelDTO> loData = JournalGroupValidateUploadError.Select((item)
                        => new ExcelDTO
                        {
                            JournalGroup = item.JournalGroup,
                            JournalGroupName = item.JournalGroupName,
