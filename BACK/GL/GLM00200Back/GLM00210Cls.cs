...
namespace GLM00200BACK
{
    public class GLM00210Cls
    {
        ...
        public GLM00210LastCurrencyRateDTO GetLastCurrency(GLM00210LastCurrencyRateDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            GLM00210LastCurrencyRateDTO loResult = null;
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<GLM00210LastCurrencyRateDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public GLM00210DTO GetJournalDisplay(GLM00210DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            GLM00210DTO loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<GLM00210DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public GLM00210DTO SaveJournal(GLM00210HeaderDetailDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            string lcQuery = "";
            ...
            DbConnection loConn = null;
            DbCommand loCmd = null;
            GLM00210DTO loRtn = poEntity.HeaderData;
            ...
            try
            {
                ...
                loDb.SqlExecNonQuery(lcQuery, loConn, false);
                loDb.R_BulkInsert<GLM00211DTO>((SqlConnection)loConn, "#GLT0100_JOURNAL_DETAIL", poEntity.DetailData);
