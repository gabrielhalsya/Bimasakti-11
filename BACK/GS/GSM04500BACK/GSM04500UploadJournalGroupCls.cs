    ...
    public class GSM04500UploadJournalGroupCls : R_IBatchProcess
    {
        ...
        public async Task _BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                var loTempObject = R_NetCoreUtility.R_DeserializeObjectFromByte<List<ExcelValidateDTO>>(poBatchProcessPar.BigObject);
                //CONVERT DATA, SO TO BE READY INSERT TO TEMPORARY TABLE 
                var loObject = R_Utility.R_ConvertCollectionToCollection<ExcelValidateDTO, TempTableDTO>(loTempObject);
