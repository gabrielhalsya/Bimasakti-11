...
{
    public class GSM04510GOADeptCls : R_BusinessObject<GOADeptDTO>
    {
        ...
        protected override void R_Deleting(GOADeptDTO poEntity)
        {
        ...
        protected override GOADeptDTO R_Display(GOADeptDTO poEntity)
        {
            string lcMethodName = nameof(R_Display);
            _loggerGSM04500.LogInfo(string.Format("START process method {0} on Cls", lcMethodName));

            R_Exception loException = new R_Exception();
            GOADeptDTO loReturn = null;
            R_Db loDb;
            ...
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<GOADeptDTO>(loReturnTemp).ToList().FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Saving(GOADeptDTO poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        public List<GOADeptDTO> JOURNAL_GROUP_GOA_DEPT_LIST(GSM04510GOADeptDBParameter poParameter)
        {
            string lcMethodName = nameof(JOURNAL_GROUP_GOA_DEPT_LIST);
            _loggerGSM04500.LogInfo(string.Format("START process method {0} on Cls", lcMethodName));
          
            R_Exception loException = new R_Exception();
            List<GOADeptDTO> loReturn = null;
            R_Db loDb;
            DbCommand loCommand;
            ...
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<GOADeptDTO>(loReturnTemp).ToList();
